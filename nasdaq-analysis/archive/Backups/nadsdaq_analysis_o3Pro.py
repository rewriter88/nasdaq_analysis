# ===========================================================
# Nasdaq "Top‑N" Momentum Strategies, 2005‑07‑01 – 2025‑06‑30# Union of all tic# Union of all trosters_by_size = {n: build_roster_df(market_cap_df, n) for n in SIZES}

# Union of all tickers ever needed, plus QQQ
all_strategy_tickers = sorted(set.union(*[set(item) for n in SIZES for item in rosters_by_size[n].tolist()]))
